...
nets = dict(
    ...
    anoncoin=math.Object(
        ...
        PERSIST=True,
        WORKER_PORT=9371,
        BOOTSTRAP_ADDRS='anc.ottrbutt.com p2pool.lurkmore.com'.split(' '),
        ANNOUNCE_CHANNEL='#p2pool-alt',
        VERSION_CHECK=lambda v: True,
    ),
    bbqcoin=math.Object(
        ...
        PERSIST=True,
        WORKER_PORT=19317,
        BOOTSTRAP_ADDRS='p2pool.lurkmore.com p2pool.org p2pool.bbqcoin.darkgamex.ch'.split(' '),
        ANNOUNCE_CHANNEL='#p2pool-alt',
        VERSION_CHECK=lambda v: True,
    ),
    franko=math.Object(
        ...
        PERSIST=True,
        WORKER_PORT=9766,
        BOOTSTRAP_ADDRS='p2pool.lurkmore.com'.split(' '),
        ANNOUNCE_CHANNEL='#p2pool-alt',
        VERSION_CHECK=lambda v: True,
    ),
    mincoin=math.Object(
        ...
        PERSIST=True,
        WORKER_PORT=9328,
        BOOTSTRAP_ADDRS='p2pool.lurkmore.com p2pool.org rav3n.dtdns.net'.split(' '),
        ANNOUNCE_CHANNEL='#p2pool-alt',
        VERSION_CHECK=lambda v: True,
    ),
    unitedscryptcoin=math.Object(
        PARENT=networks.nets['unitedscryptcoin'],
        SHARE_PERIOD=15,
        CHAIN_LENGTH=24 * 60 * 60 // 10,
        REAL_CHAIN_LENGTH=24 * 60 * 60 // 10,
        TARGET_LOOKBEHIND=200,
        SPREAD=3,
        IDENTIFIER='6c75726b6d6f7265'.decode('hex'),
        PREFIX='6368616e6368616e'.decode('hex'),
        P2P_PORT=23333,
        MIN_TARGET=0,
        MAX_TARGET=2 ** 256 // 2 ** 20 - 1,
        PERSIST=True,
        ...
        ANNOUNCE_CHANNEL='#p2pool-alt',
        VERSION_CHECK=lambda v: True,
        VERSION_WARNING=lambda v: 'Upgrade UnitedScryptCoin to >=0.8.6.1!' if v < 80601 else None,
    ),
